...
architecture Structual of snn_top_level is
  ...
  signal argmax_prediction_ready : std_logic;
...
begin
  ...
  layer_controller_inst : entity work.layer_controller
    ...
    (
      ...
      prediction_ready  => argmax_prediction_ready
    );
  ...
  argmax_unit_inst : entity work.argmax_unit
    ...
    -- Connect the predicted label from argmax unit to the top-level's output.
      prediction_ready <= argmax_prediction_ready;
