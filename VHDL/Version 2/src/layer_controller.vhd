...
entity layer_controller is
  ...
  port (
    ...
    prediction_ready : in std_logic -- Signal from the argmax_unit to indicate that the predicted label is ready.
  );
    ...
    if rst = '1' then
      ...
      case current_state is
        ...
        when ARGMAX_COMPUTING =>
          ...
          if prediction_ready = '1' then -- Wait for 10 or 20 clock cycles until argmax unit calculates the predicted label.
